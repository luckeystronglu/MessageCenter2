...
public class Chart extends View{
    ...
    protected int xpCount = 5;//x轴坐标点数
...
//            xCoordinates[i] = (i+1) * xSpacing - 100;
//            xCoordinates[i] = (i+1) * xSpacing;
            xCoordinates[i] = (int)((float)(i + 0.5) * xSpacing + xSurplus/2);
    ...
    private void initCoordinateSystem(Canvas canvas){
        ...
        //draw y 坐标
//        canvas.drawLine(oX,oY, oX,oY-yHeight,mainPaint); //20170417 取消
        //draw x 坐标
...
//            }else {
//                datay = new DecimalFormat("0.00").format(yMax/ypCount*(j+1));
//            }
//
//            //获取文字宽高
...
//            //画y轴文字
////            canvas.drawText(datay,oX-textX,oY-yCoordinates[j]+textY,textPaint); //20170417 取消
//        }
    }
